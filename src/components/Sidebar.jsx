...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[280px] glass-dark-bespoke h-[calc(100vh-4rem)] rounded-[32px] fixed top-8 right-8 flex flex-col py-8 z-40 overflow-hidden shadow-2xl">
      {/* Brand */}
      <div className="flex items-center px-8 mb-12 relative z-10">
        ...
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-white shrink-0 relative group">
